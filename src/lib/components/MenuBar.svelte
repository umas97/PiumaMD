...
>
  <div class="flex items-center gap-1 h-full">
    ...
    <div class="relative h-full">
      ...
      {#if activeMenu === "info"}
        <div
          class="absolute top-full left-0 w-64 bg-surface border border-outline/10 shadow-xl rounded-b-md p-4 animate-in fade-in slide-in-from-top-1"
        >
          <div class="flex flex-col items-center gap-2 text-center">
            ...
            <div class="text-[10px] italic">
              Editor Markdown leggero progettato per la velocità e la
              semplicità.
            </div>
            <button
              onclick={() => {
